package com.sorokin.dogWalkingService.myPlugin.listener;
...
import com.sorokin.dogWalkingService.myPlugin.managers.LogManager;
...
import com.sorokin.dogWalkingService.myPlugin.services.jira.IssueConstants;
...
public class Listener implements InitializingBean, DisposableBean {
    ...
    public void onIssueEvent(IssueEvent issueEvent){
        ...
        if (eventTypeId.equals(EventType.ISSUE_UPDATED_ID)) {
            ...
            // пока отслеживается только состороны моего юая
            if (issue.getIssueTypeId().equals(IssueConstants.ISSUE_TYPE_CLIENT_ID.getId())) {
