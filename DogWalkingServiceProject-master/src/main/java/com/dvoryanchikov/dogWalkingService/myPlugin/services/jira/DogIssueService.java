...
//
//            issueInputParameters.addCustomFieldValue("customfield_10101", updatedDog.getDogName());
//            issueInputParameters.addCustomFieldValue("customfield_10100", updatedDog.getGender());
//            issueInputParameters.addCustomFieldValue("customfield_10102", updatedDog.getDogBirthDate().toString());
//            issueInputParameters.addCustomFieldValue("customfield_10103", updatedDog.getBreed());
//            issueInputParameters.addCustomFieldValue("customfield_10104", updatedDog.getColor());
//            issueInputParameters.addCustomFieldValue("customfield_10105", updatedDog.getDogCharacter());
//            issueInputParameters.addCustomFieldValue("customfield_10106", updatedDog.getDogStatus().toString());
//            issueInputParameters.addCustomFieldValue("customfield_10121", findFullName(updatedDog.getOwnerId()));
//
